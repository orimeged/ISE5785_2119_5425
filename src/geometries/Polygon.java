...
public class Polygon extends Geometry {
     ...
     *
     * @param point The ray to find intersections with.
     * @return the normal
     */
    @Override
...
//    /**
//     * Finds intersections between the given ray and the list of point
//     *
//     * @param ray The ray to find intersections with.
//     * @return A list of Geopoints representing the intersections with the ray.
//     */
//    @Override
