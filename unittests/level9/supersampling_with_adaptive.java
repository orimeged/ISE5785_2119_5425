...
public class supersampling_with_adaptive {
...
//         Smaller, twinkling stars in the upper half only (commented out as in original)
    ...
    public void testMissileSceneComparison() {
        ...
        // 2. עם Regular Supersampling
        System.out.println("Rendering with supersampling_with_adaptive...");
        cameraBase
                .setNumberOfRays(numRays)
                .setAdaptive(true)
                .setImageWriter(new ImageWriter("Missile_supersampling_with_adaptive", 1000, 1000))
                .build()
                .renderImage()
                .writeToImage();
