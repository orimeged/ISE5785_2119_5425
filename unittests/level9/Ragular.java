...
public class Ragular {
    ...
    private final Scene scene = new Scene("Realistic Earth and Missile Scene");
...
//         Smaller, twinkling stars in the upper half only (commented out as in original)
    ...
    public void testMissileSceneComparison() {
        System.out.println("Rendering without ragular...");
        cameraBase
                .setNumberOfRays(1)
                .setAdaptive(false)
                .setImageWriter(new ImageWriter("Ragular", 1000, 1000))
                .build()
                .renderImage()
                .writeToImage();
    }
