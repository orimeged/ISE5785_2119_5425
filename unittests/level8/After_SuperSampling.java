...
public class After_SuperSampling {
    ...
    private final Camera.Builder camera = Camera.getBuilder()
            ...
            .setNumberOfRays(50); // Supersampling
    ...
    private void createScene() {
        ...
        scene.lights.add(new SpotLight(new Color(255, 220, 180), new Point(90, 80, -100), new Vector(-1, -1, -0.5))
                .setKL(0.00005).setKQ(0.000005).setNarrowBeam(12).setSize(8));
